...
class View extends \Kotchasan\View
{
     ...
     * @param bool $hide ถ้าเป็น true จะแสดงเป็นข้อความและปิด 4 ตัวหลัง
     *
     * @return string
     */
    public static function showPhone($phone_number, $hide = false)
    {
    ...
    {
        $result = [];
        foreach (Language::get('LOGIN_FIELDS') as $key => $value) {
            if (in_array($key, self::$cfg->login_fields)) {
                $result[] = $value;
            }
        }
